...
function update.createInstallationDisk()
    ...
    elseif #emptyDisksLoc > 1 then
        ...
        installGithub("FrOS/config.stg", "temp/install/FrOS/config.stg")
        ...
        installGithub("FrOS/sys/stg.lua", "temp/install/FrOS/sys/stg.lua")
        installGithub("FrOS/sys/taskScheduler.lua", "temp/install/FrOS/sys/taskScheduler.lua")
